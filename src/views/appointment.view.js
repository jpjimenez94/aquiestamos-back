...
export function cita(c) {
  return {
    ...
    salaTokenPaciente: (c.meetingUrl || c.modality === 'VIRTUAL') ? generarTokenSala(c.id, 'PACIENTE') : null,
    salaTokenProfesional: (c.meetingUrl || c.modality === 'VIRTUAL') ? generarTokenSala(c.id, 'PROFESIONAL') : null,
